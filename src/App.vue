...
const searchToken = import.meta.env.NICOBAR_SEARCH_TOKEN as string;
const applicationId = import.meta.env.NICOBAR_APPLICATION_ID as string;
const collectionId = import.meta.env.NICOBAR_COLLECTION_ID as string;
