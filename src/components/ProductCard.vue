<template>
  <div class="max-w-xs mx-auto bg-white overflow-hidden transition-all duration-300">
      ...
      <span class="absolute top-3 bg-white text-xs font-semibold px-2 py-1 z-10">
        ...
        <Transition :name="transitionDirection" mode="out-in">
            <img 
                ...
                :src="product.imageSrc[product.imageIndex]" 
                :alt="product.name" 
      ...
      <div class="flex items-center justify-between mt-1 mb-3">
        <div class="flex space-x-2 text-[10px]">
          <button 
            ...
            :key="size"
            :class="[
              'pr-2 h-2 flex items-center justify-center rounded-sm',
            ]"
          >
            {{ size }}
          </button>
...
export default defineComponent({
  ...
  data() {
    return {
      product: {
        name: 'Astral Kurta - Ivory Embroidered',
        price: 10000,
        material: 'LINEN BLEND',
        sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL'],
        colors: [
          { name: 'Light Yellow', code: '#FFFFED' },
          { name: 'Ivory', code: '#FFFFF0' }, 
          { name: 'Purple', code: '#5c105c' },
        ],

        

        imageSrc: ['https://cdn.shopify.com/s/files/1/0270/5129/4854/files/NBI047084_1_470x.jpg?v=1759926273',
                    'https://cdn.shopify.com/s/files/1/0270/5129/4854/files/NBI047084_2_470x.jpg?v=1759926274',
                    'https://cdn.shopify.com/s/files/1/0270/5129/4854/files/NBI047084_2_470x.jpg?v=1759926274',
                    'https://cdn.shopify.com/s/files/1/0270/5129/4854/files/NBI047084_4_470x.jpg?v=1759926278',
                    'https://cdn.shopify.com/s/files/1/0270/5129/4854/files/NBI047084_5_470x.jpg?v=1759926280',
                    'https://cdn.shopify.com/s/files/1/0270/5129/4854/files/NBI047084_6_470x.jpg?v=1759926281',
                    ],
        imageIndex: 0,
      },
  ...
  methods: {
    nextImage(step: number) {
      const numImages = this.product.imageSrc.length;
      let newIndex = this.product.imageIndex + step;
      ...
      this.product.imageIndex = newIndex;
    }
  },
});
</script>
