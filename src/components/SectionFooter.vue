<template>
    <footer id="section-footer" class="Footer footer-wrapper ">
        <div class="footer-wrapper py-8.5 mt-3.75">
            <!-- Sign ME UP Section -->
            <div class="footer-sign-me  flex text-[#6a6a6a] bg-[#f7f9fb] h-[186px] relative items-center mb-2.5 pb-2.5">
                <div class="sign-me-img w-1/5 relative h-full">
                <img loading="lazy" class="sign-sun-img max-w-full h-auto align-top border-none absolute w-[37px] right-0 top-[61px]" src="https://cdn.shopify.com/s/files/1/0270/5129/4854/files/Elements_3-06_2x_58f930e2-995a-4525-bd72-b1d03dd84f0f.png?v=1686549892">
                <img loading="lazy" class="sign-tree-big w-14 absolute bottom-[-13px] right-[51px]" src="https://cdn.shopify.com/s/files/1/0270/5129/4854/files/Elements_3-05_2x_6d901bc1-2142-43bc-8310-bb686d43c745.png?v=1686549910">
                <img loading="lazy" class="sign-tree-small  w-[29px] absolute bottom-[-13px] right-[23px]" src="https://cdn.shopify.com/s/files/1/0270/5129/4854/files/Elements_3-05_2x_09b47d4b-547c-4c2d-8c35-9f396572ecf9.png?v=1686549905">
            </div>
                <div class="sign-me-form flex flex-col w-3/5 relative m-auto pl-20 pr-[120px]">
                    <h1 class="text-center">Get on the List</h1>
                    <p class="text-center text-[12px] pb-[11px]">
                        Perks included
                        <b>10<span class="percentage-sign pr-0.5">%</span>off</b> your first online order. Be the first to know <br>
                        about new collections, store launches, sales, and much more!
                    </p> 
                    <div class="sign-me-btn flex justify-center w-[525px] relative m-auto">
                        <input type="text" class="bg-white w-[348px] mt-2.5 mb-0 mx-0 border-[none] px-3.5 py-[10.5px]" autocomplete="off" placeholder="Enter your email address here" id="sign-input">
                        <span class="tracking-[1.2px] text-white opacity-100 leading-10 w-[136px] text-center cursor-pointer ml-[5px] mr-0 mt-2.5 mb-0 bg-[#1f3c56]">SIGN ME UP</span>
                            <img loading="lazy" class="absolute leading-10 text-center w-14 right-1 bottom-5" src="https://cdn.shopify.com/s/files/1/0270/5129/4854/files/Elements_3-08_2x_f4355105-f310-4572-8bef-8bd007434539.png?v=1686550817">
                        <div class="sign-me-form-error"></div>
                        <div class="sign-me-form-success"></div>
                    </div>
                    
                </div>
                <div class="sign-me-tree w-1/5 relative h-full">
                    <img loading="lazy" class="sign-tree-big  w-14 absolute bottom-[-13px] left-0" src="https://cdn.shopify.com/s/files/1/0270/5129/4854/files/Elements_3-05_2x_6d901bc1-2142-43bc-8310-bb686d43c745.png?v=1686549910">
                    <img loading="lazy" class="sign-tree-small  w-7 absolute bottom-[-13px] left-[57px]" src="https://cdn.shopify.com/s/files/1/0270/5129/4854/files/Elements_3-05_2x_09b47d4b-547c-4c2d-8c35-9f396572ecf9.png?v=1686549905">
                </div>
            </div>

            <!-- Delivery Detail Section -->
             <div class="delivery-detail-section">
                <div class="delivery-wrapper-section flex items-center flex-[100%] p-5">
                    <div class="delivery-detail-item flex-[0_0_25%] text-center grow px-[5px] py-0 h-full">
                        <div class="delivery-detail-block flex flex-row align-middle justify-center px-[30px] py-6 bg-[#f7f9fb] h-full">
                            <div class="icon-wrapper flex items-center">
                                <div class="icon icon-1 inline-flex pr-[15px]"><img loading="lazy" src="//www.nicobar.com/cdn/shop/files/return.svg?v=1676354450"></div>
                            </div>
                            <div class="text">
                                <div class="title text-[#424954] text-[16px] text-left font-bold leading-[1.65]">Easy returns
                                
                                </div>
                                <div class="desc text-[#7c878e] text-[13px]"><p>Return within 15 days of <br> order delivery. <a href="https://www.nicobar.com/pages/return-and-exchange" target="_blank" class="nrp-see-more-clk underline">See T&amp;Cs</a></p></div>
                            </div>
                        </div>
                    </div>
                    <div class="delivery-detail-item flex-[0_0_25%] text-center grow px-[5px] py-0 h-full">
                        <div class="delivery-detail-block  flex flex-row align-middle justify-center px-[30px] py-6 bg-[#f7f9fb] h-full">
                            <div class="icon-wrapper flex items-center">
                                <div class="icon icon-1 inline-flex pr-[15px]"><img loading="lazy" src="//www.nicobar.com/cdn/shop/files/noun-car-2164405_79b2948c-e083-445b-959b-b2a39a68967f.svg?v=1697622804"></div>
                            </div>
                            <div class="text">
                                <div class="title text-[#424954] text-[16px] text-left font-bold leading-[1.65]">We ship worldwide
                                
                                </div>
                                <div class="desc text-[#7c878e] text-[13px]"><p>visit <a href="https://www.nicobar.com/pages/return-and-exchange" target="_blank" class="nrp-see-more-clk underline">global.nicobar.com</a></p></div>
                            </div>
                        </div>
                    </div>
                    <div class="delivery-detail-item flex-[0_0_25%] text-center grow px-[5px] py-0 h-full">
                        <div class="delivery-detail-block flex flex-row align-middle justify-center px-[30px] py-6 bg-[#f7f9fb] h-full">
                            <div class="icon-wrapper flex items-center">
                                <div class="icon icon-1 inline-flex pr-[15px]"><img class="w-9.5" loading="lazy" src="//www.nicobar.com/cdn/shop/files/order_8622de0f-60e9-46d3-92e9-6cf71c37efd1.svg?v=1708946569"></div>
                            </div>
                            <div class="text">
                                <div class="title text-[#424954] text-[16px] text-left font-bold leading-[1.65]">
                                    Free shipping
                                </div>
                                <div class="desc text-[#7c878e] text-[13px]"><p>Free shipping on orders <br> above ₹ 1,000.</p></div>
                            </div>
                        </div>
                    </div>
                    <div class="delivery-detail-item flex-[0_0_25%] text-center grow px-[5px] py-0 h-full">
                        <div class="delivery-detail-block flex flex-row align-middle justify-center px-[30px] py-6 bg-[#f7f9fb] h-full">
                                <div class="icon icon-1 inline-flex pr-[15px]"><img loading="lazy" src="//www.nicobar.com/cdn/shop/files/cash.svg?v=1676354450">
                            </div>
                            <div class="text">
                                <div class="title text-[#424954] text-[16px] text-left font-bold leading-[1.65]">Cash on Delivery
                                
                                </div>
                                <div class="desc text-[#7c878e] text-[13px]"><p>COD available.</p></div>
                            </div>
                        </div>
                    </div>
             ...
             <!-- Footer Middle Block -->
             <div class="footer-middle-block  p-10 flex">
                <div class="footer-middle-left py-10 w-[30%] flex justify-center flex-col bg-[#f7f9fb] relative pl-3">
                       <div class="find-store-text">
                            <div class="find-store-text">
                                <a class="xs-hide store-page flex gap-2 items-center pb-10" href="/pages/delhi-store" target="_blank">
                ...
                <div class="footer-middle-right py-10 w-[70%]  bg-white">
                    <div class="three-part-container flex-[0_0_100%] max-w-full flex h-full">
                        <div class="linklist-container flex justify-center flex-[0_0_33%] max-w-[33%] border-r-[#6A6A6A] border-r border-solid">
                            <div class="linklist-block-inner flex justify-center">
                                <div class="linklist-block-wrapper">
                                    ...
                                    <ul class="text-[#565e6b] text-[14px]">
                                        <li>Our Story</li>
                                        <li>In the press</li>
                                        <li>Work with us</li>
                                        <li>Contact us</li>
                                    </ul>
                                    <div class="footer-social-icons flex mt-8">
                                        <div class="instagram-icon h-10 w-10 flex ml-1 mr-6">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 15.78 15.78">
                                                    <g id="insta-icon" transform="translate(-94.117 -353.751)">
                                                        <g id="Group_13" data-name="Group 13" transform="translate(94.117 353.751)">
                                                        <path id="Path_12" data-name="Path 12" d="M102.007,355.173c2.107,0,2.356.008,3.188.046a4.355,4.355,0,0,1,1.465.271,2.615,2.615,0,0,1,1.5,1.5,4.365,4.365,0,0,1,.272,1.465c.038.832.046,1.081.046,3.188s-.008,2.356-.046,3.188a4.364,4.364,0,0,1-.272,1.465,2.611,2.611,0,0,1-1.5,1.5,4.368,4.368,0,0,1-1.465.272c-.832.038-1.081.046-3.188.046s-2.356-.009-3.188-.046a4.365,4.365,0,0,1-1.465-.272,2.611,2.611,0,0,1-1.5-1.5,4.364,4.364,0,0,1-.272-1.465c-.038-.832-.046-1.081-.046-3.188s.008-2.356.046-3.188a4.365,4.365,0,0,1,.272-1.465,2.615,2.615,0,0,1,1.5-1.5,4.352,4.352,0,0,1,1.465-.271c.832-.038,1.081-.046,3.188-.046m0-1.422c-2.143,0-2.412.009-3.253.047a5.777,5.777,0,0,0-1.915.367,4.03,4.03,0,0,0-2.307,2.307,5.781,5.781,0,0,0-.367,1.915c-.038.842-.047,1.111-.047,3.253s.009,2.412.047,3.253a5.778,5.778,0,0,0,.367,1.915,4.033,4.033,0,0,0,2.307,2.308,5.793,5.793,0,0,0,1.915.367c.842.038,1.11.047,3.253.047s2.412-.009,3.253-.047a5.793,5.793,0,0,0,1.915-.367,4.036,4.036,0,0,0,2.308-2.308,5.8,5.8,0,0,0,.367-1.915c.038-.842.047-1.111.047-3.253s-.009-2.412-.047-3.253a5.8,5.8,0,0,0-.367-1.915,4.033,4.033,0,0,0-2.308-2.307,5.777,5.777,0,0,0-1.915-.367c-.842-.038-1.11-.047-3.253-.047" transform="translate(-94.117 -353.751)" fill="#707070"></path>
                                                        <path id="Path_13" data-name="Path 13" d="M104.264,360.076a3.823,3.823,0,1,0,3.823,3.823,3.823,3.823,0,0,0-3.823-3.823m0,6.3a2.481,2.481,0,1,1,2.481-2.481,2.481,2.481,0,0,1-2.481,2.481" transform="translate(-96.374 -356.009)" fill="#707070"></path>
                                                        <path id="Path_14" data-name="Path 14" d="M114.506,359.256a1,1,0,1,1-1-1,1,1,0,0,1,1,1" transform="translate(-101.435 -355.543)" fill="#707070"></path>
                                                        </g>
                                                    </g>
                                                    </svg>
                                            </span>
                                        </div>
                                        <div class="linkedin-icon h-10 w-10 flex mr-8">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="19.773" height="19.771" viewBox="0 0 19.773 19.771">
                                                ...
                                                <path id="Path_1048" data-name="Path 1048" d="M16.848,16.847h-2.93V12.257c0-1.094-.02-2.5-1.524-2.5-1.526,0-1.76,1.192-1.76,2.423v4.669H7.7V7.411h2.812V8.7h.038a3.082,3.082,0,0,1,2.775-1.524c2.969,0,3.517,1.953,3.517,4.494ZM4.4,6.121a1.7,1.7,0,1,1,1.7-1.7h0a1.7,1.7,0,0,1-1.7,1.7M5.864,16.846H2.931V7.411H5.864ZM18.307,0H1.459A1.441,1.441,0,0,0,0,1.424s0,0,0,0V18.344A1.444,1.444,0,0,0,1.459,19.77H18.307a1.447,1.447,0,0,0,1.466-1.427V1.424A1.446,1.446,0,0,0,18.307,0" transform="translate(0 0.001)" fill="#565e6b"></path>
                                                </g>
                                                </g>
                                            </svg>
                                        </div>
